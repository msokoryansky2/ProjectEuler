...
class P0055 extends EulerProblem {
  def run: String = (1 until 10000).count(HugePositiveInt(_).presumedLychrel()).toString
}

object P0055 extends App {
  (new P0055).printAnswer()
}
