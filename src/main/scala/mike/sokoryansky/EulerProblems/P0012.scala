...
import mike.sokoryansky.MathUtils.{Integer, PolygonalNumber, Triangle}
...
class P0012 extends EulerProblem {
  ...
  //def run2: String = Triangle.triangleNumbers(0, 0).filter{ (n) => Integer.divisors(n).toList.length > 500}.head.toString
}
